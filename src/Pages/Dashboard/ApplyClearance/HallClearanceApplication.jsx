...
const HallClearanceApplication = ({ click, setClick }) => {
      ...
      <Card className="w-full px-4 py-5">
        ...
        >
          ...
          <div className="flex gap-x-2 my-5">
            <Button
              onClick={() => setClick({ ...click, hallClick: '' })}
              variant="gradient"
              color="red"
        ...
        <div className="mb-2">
          <Typography variant="paragraph" className="flex justify-center">
            Want to pay due of {click.hallClick} Dept?
            <Link
              to="/"
...
export default HallClearanceApplication;
